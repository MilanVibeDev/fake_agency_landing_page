  ...
  return (
    <section className="py-24 max-w-7xl mx-auto w-full">
      <div className="container flex flex-col items-center text-center">
        <h2 className="my-6 text-2xl font-bold text-pretty lg:text-3xl text-slate-300">
          {heading}
        </h2>
      </div>
      <div className="pt-10 md:pt-16 lg:pt-20 w-full overflow-hidden">
        <div className="relative mx-auto flex items-center justify-center lg:max-w-5xl">
                  ...
                  <div className="mx-10 flex shrink-0 items-center justify-center">
                    <div>
                      <img
                        ...
                        className={logo.className + " grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition duration-300"}
                      />
                    </div>
                  </div>
                </CarouselItem>
          ...
          <div className="absolute inset-y-0 left-0 w-12 bg-gradient-to-r from-slate-950 to-transparent"></div>
          <div className="absolute inset-y-0 right-0 w-12 bg-gradient-to-l from-slate-950 to-transparent"></div>
        </div>
      </div>
    </section>
  );
