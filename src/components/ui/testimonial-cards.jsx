...
export function TestimonialCard ({ handleShuffle, testimonial, position, id, author }) {
  ...
  return (
    <motion.div
      ...
      className={`absolute left-0 top-0 grid h-[400px] w-[320px] select-none place-content-center space-y-6 rounded-2xl border-2 border-slate-700 bg-slate-800/80 p-6 shadow-xl backdrop-blur-md ${
